...
export default function TransportRequestsPage() {
  ...
  const fetchTransportRequests = useCallback(async (page = 1) => {
    ...
    try {
      ...
      console.log("TransportRequestsPage: Fetched transport requests data:", data);
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Search and filter your transport requests by various criteria.
          </CardDescription>
        </CardHeader>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            List of your submitted transport requests. Total: {isLoading && totalRequests === 0 ? <Loader2 className="h-4 w-4 animate-spin inline-block" /> : totalRequests}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading && transportRequests.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">Click "Create New Request" to get started.</p>
              {hasActiveFilters && (
